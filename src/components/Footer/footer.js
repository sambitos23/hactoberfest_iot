...
function Footer() {
  return (
    <div className="bg-secondary-default px-10 md:px-6 lg:px-24 pt-16 text-secondary-200 font-medium">
      <div class="grid grid-cols-1 md:grid-cols-5 pb-8">
        <div class="col-span-1 md:col-span-3 flex flex-col items-center text-center md:text-left md:items-start space-y-3">
          <h2 class="text-xl text-dorange uppercase font-bold tracking-widest">
            Giving
          </h2>
          <div class="launch-desc text-sm">
        ...
        <div class="col-span-1 legal flex flex-col items-center md:items-start space-y-2 text-left md:ml-28">
          <h2 class="text-sm md:text-base text-dorange uppercase font-bold mt-10 md:mt-0">
            Share
          </h2>{" "}
          <a
        ...
        <div class="col-span-1 legal flex flex-col items-center md:items-start md:ml-28 space-y-2 text-left">
          <h2 class="text-sm md:text-base text-dorange uppercase font-bold mt-10 md:mt-0">
            Legal
          </h2>{" "}
          <a
